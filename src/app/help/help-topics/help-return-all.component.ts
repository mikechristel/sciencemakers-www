...
@Component({
    selector: 'thda-help-return-all',
    templateUrl: './help-return-all.component.html',
    styleUrls: ['../help.component.scss']
})
export class HelpReturnAllComponent extends ThinBaseComponent implements OnInit {
    ...
    ngOnInit() {
        var leadingPiece: string = "Help Page, Return All Stories";
