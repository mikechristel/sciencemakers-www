...
@Component({
    selector: 'thda-help-facet-origins',
    templateUrl: './help-facet-origins.component.html',
    styleUrls: ['../help.component.scss']
})
export class HelpFacetOriginsComponent extends ThinBaseComponent implements OnInit {
    ...
    ngOnInit() {
        var leadingPiece: string = "Help Page, Facet Origins";
