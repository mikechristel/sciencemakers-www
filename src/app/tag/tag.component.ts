...
export class TagComponent extends BaseComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        // i.e., tacking on ", ScienceMakers Digital Archive"):
        this.titleManagerService.setTitle("Topic Search, ScienceMakers Digital Archive");
    ...
    private setFocusAsNeeded() {
        // Forget some signalling to other routes, given this context of topic/tag search has no selected story or bio.
